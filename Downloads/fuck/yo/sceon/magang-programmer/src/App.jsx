...
import officeImg from './assets/off4.jpg'
import officeImg2 from './assets/off1.jpg'
import officeImg3 from './assets/off0.jpg'
...
import item1 from './assets/item6.png'
import item2 from './assets/item2.png'
import item3 from './assets/item3.png'
import item4 from './assets/item4.png'
import item5 from './assets/item7.png'
...
//////
 const levels = [
...

  {
    ...
    pins: [
        { id: 1, top: '30%', left: '71%', img: item2 },
      { id: 2, top: '55%', left: '90%', img: item2},
      { id: 3, top: '20%', left: '10%', img: item2 },
      { id: 4, top: '75%', left: '30%', img: item2 },
      { id: 5, top: '60%', left: '20%', img: item2 },
    ],
    questions: [
      {
        id: 1,
...

  {
    ...
    pins: [
      ...
      { id: 2, top: '15%', left: '90%', img: item5 },
      { id: 3, top: '30%', left: '10%', img: item5 },
